        ...
        if result:
            ...
            if outputs.multi_face_landmarks:
                ...
                if frame_count > min_frame:
                    # Closing the eyes
                    speech.say('Driver Safety Alert: It Seems you are sleeping.  Wake up')
                    sleep_msg = 'Driver Safety Alert: It Seems you are sleeping.  Wake up'
                    speech.runAndWait()
                ...
                if ratio_lips < 1.8:
                    # Open his mouth
                    speech.say('Driver Safety Warning: You look tired. Stop at the nearest opportunity')
                    yawn_msg = 'Driver Safety Warning: You look tired. Stop at the nearest opportunity'
                    speech.runAndWait()
