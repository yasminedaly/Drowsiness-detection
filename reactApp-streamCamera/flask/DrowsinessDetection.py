...
def detect_drowsiness():
        ...
        if result:
            ...
            if outputs.multi_face_landmarks:
                ...
                if frame_count > min_frame:
                    #Closing the eyes
                    speech.say('Driver Safety Alert: It Seems you are sleeping. Please pullover in the nearest safe space.')
                    sleep_msg = 'Driver Safety Alert: It Seems you are sleeping. Please pullover in the nearest safe space.'
                    speech.runAndWait()
                ...
                if ratio_lips < 1.8:
                    #Open his mouth
                    speech.say('Driver Safety Warning: You looks tired. Please pullover and rest')
                    yawn_msg = 'Driver Safety Warning: You looks tired. Please rest'
                    speech.runAndWait()
    ...
    return {"code": 200,
        "sleep_message": sleep_msg,
        "yawn_message": yawn_msg}
